...
<div class="flex mb-8 mt-4 justify-center font-inter px-16" aria-label="Breadcrumb">
    <ol class="inline-flex flex-grow items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li class="inline-flex items-center">
            <a href="{{ url('/pembelian') }}" class="inline-flex items-center text-base font-medium text-navy hover:text-blueish">
                Pembelian
            </a>
            <svg class="rtl:rotate-180 w-3 h-3 text-gray-400 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 9 4-4-4-4" />
...
<div class="grid grid-cols-2 py-8 px-16 gap-12 bg-white-broke mb-8">
        ...
        @csrf
            <div class="my-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="nama" name="nama" class="text-sm font-semibold w-3/4 rounded-lg bg-gray-200 mt-1">
                </div>
                <div class="mb-3">
                    <label for="notelp" class="text-base font-bold">No. Telpon</label><br>
                    <input type="text" id="notelp" name="notelp" class="text-sm font-semibold w-3/4 rounded-lg bg-gray-200 mt-1">
                </div>
                <div class="mb-3">
    ...
    <div class="h-full pb-12">
        ...
        <div class="h-full border-4 border-gray-200 p-6 flex flex-col justify-between">
            <div class="grid grid-cols-2 gap-2 border-b-4 border-gray-200">
                <img src="{{ url('/assets/motorlist.png') }}" alt="">
                <div>
                    <h2 class="text-2xl font-bold">Ducati Streetfighter V4</h2>
                    <p class="text-xl font-semibold">IDR 330.499.000</p>
                </div>
            </div>
            <div class="">
                <div class="text-3xl font-bold mb-2">Total IDR 330.499.000</div>
                <button type="submit" form="form-pembayaran" class="py-2 px-12 rounded-lg shadow bg-blue-old text-center text-lg font-bold text-white hover:bg-blue-900">Bayar</button>
            </div>
        </div>
    </div>
</div>
