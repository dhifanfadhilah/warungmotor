...
<div class="w-full px-56 my-12 flex flex-row flex-wrap">
    <div class="relative w-1/4 border-r-2 border-gray-200">
    ...
    <div class="w-4/6" id="default-tab-content">
        ...
        <h1 class="text-2xl font-bold text-center mb-6">Favorite</h1>
        </div>
        <div class="hidden px-24" id="watchlist" role="tabpanel" aria-labelledby="watchlist-tab">
        <h1 class="text-2xl font-bold text-center mb-6">Watchlist</h1>
        </div>
        <div class="hidden px-24" id="setting" role="tabpanel" aria-labelledby="setting-tab">
        <h1 class="text-2xl font-bold text-center mb-6">Setting</h1>
        </div>
        <div class="hidden px-24" id="history" role="tabpanel" aria-labelledby="history-tab">
        <h1 class="text-2xl font-bold text-center mb-6">History</h1>
        </div>
    </div>
</div>
@endsection