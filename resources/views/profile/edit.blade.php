...
<div class="w-full px-56 my-12 flex flex-row flex-wrap">
    <div class="relative w-1/4 border-r-2 border-gray-200">
        ...
        <ul class="flex flex-col justify-between h-108 text-lg font-medium" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist" data-tabs-active-classes="border-r-4 border-red-500 bg-gray-300">
            <div>
